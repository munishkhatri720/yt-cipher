...
- `FIXED_PLAYER_URL` - When set, this overrides the player URL used for extracting the `sts` value in the `/get_sts` endpoint. Don't specify this unless everything is broken and you need a quick fix.
